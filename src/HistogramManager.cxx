...
void HistogramManager::InitialiseHistograms(){
  ...
  // Find number of bins
  const Long64_t implantDecayBins = 2 * ConfigReader::Instance().GetTimeThreshold() / HistogramConstants::implantDecayBinDt;
  ...
  h1_aida_implant_beta_dt = new TH1D("aida_implant_beta_firstmatch_dt", "Implant-Decay #Deltat (First Match);Implant-Decay #Deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  h1_aida_implant_beta_dt_forward = new TH1D("aida_implant_beta_firstmatch_dt_forward", "Implant-Decay #Deltat (First Match-Forward);Implant-Decay #Deltat (); Counts/", implantDecayBins / 2, 0, ConfigReader::Instance().GetTimeThreshold());
  h1_aida_implant_beta_dt_backward = new TH1D("aida_implant_beta_firstmatch_dt_backward", "Implant-Decay #Deltat (First Match-Backward);Implant-Decay #Deltat (); Counts/", implantDecayBins / 2, 0, ConfigReader::Instance().GetTimeThreshold());
  h1_aida_implant_beta_secondmatch_dt = new TH1D("aida_implant_beta_secondmatch_dt", "Implant-Decay #Deltat (Second Match);Implant-Decay #Deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  h1_aida_implant_beta_thirdmatch_dt = new TH1D("aida_implant_beta_thirdmatch_dt", "Implant-Decay #Deltat (Third Match);Implant-Decay #Deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  h1_aida_implant_beta_tenthmatch_dt = new TH1D("aida_implant_beta_tenthmatch_dt", "Implant-Decay #Deltat (Tenth Match);Implant-Decay #Deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  ...
  h2_gatedimplantbetagamma_betagamma_dt_vs_implantbeta_dt = new TH2D("gatedimplantbetagamma_betagamma_dt_vs_implantbeta_dt", "Implant-Beta-Gamma ImplantBeta dt vs BetaGamma dt;betagamma dt (ns); ionbeta dt(ns)", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold(), 1000, -20, 2e3);
  ...
  h2_allimplantbetagamma_betagamma_dt_vs_implantbeta_dt = new TH2D("allimplantbetagamma_betagamma_dt_vs_implantbeta_dt", "Implant-Beta-Gamma ImplantBeta dt vs BetaGamma dt;betagamma dt (ns); ionbeta dt(ns)", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold(), 1000, -20, 2e3);
  h2_allimplantbetagamma_gammaenergy_vs_implantbeta_dt = new TH2D("allimplantbetagamma_gammaenergy_dt_vs_implantbeta_dt", "Implant-Beta-Gamma ImplantBeta dt vs Gamma energy;betagamma dt (ns); Energy (keV)", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold(), 2000, 0, 2000);

  // Correlate forward implant-decay dt with other observables
  h2_implant_energy_dt_forward = new TH2D("implant_energy_dt_forward", "Implant Energy vs Implant-Decay dt", 7000 / 20, 0, 7000, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_decay_energy_dt_forward = new TH2D("decay_energy_dt_forward", "Decay Energy vs Implant-Decay dt (Forward)", 1500 / 10, 0, 1500, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_strip_dt_forward = new TH2D("strip_dt_forward", "Strip XY vs Implant-Decay dt (Forward)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());

  // Correlate backward implant-decay dt with other observables
  h2_implant_energy_dt_backward = new TH2D("implant_energy_dt_backward", "Implant Energy vs Implant-Decay dt (Backward)", 7000 / 20, 0, 7000, implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), 0);
  h2_decay_energy_dt_backward = new TH2D("decay_energy_dt_backward", "Decay Energy vs Implant-Decay dt (Backward)", 1500 / 10, 0, 1500, implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), 0);
  h2_strip_dt_backward = new TH2D("strip_dt_backward", "Strip XY vs Implant-Decay dt (Backward)", 528, 0, 528, implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), 0);
  ...
  h1_aida_implant_beta_dt_candidate_cut = new TH1D("aida_implant_beta_dt_candidate_cut", "Implant-Decay #Deltat (Beta Candidate Cut);Implant-Decay #deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  h2_implant_energy_dt_candidate_cut = new TH2D("implant_energy_dt_candidate_cut", "Implant Energy vs Implant-Decay dt (Beta Candidate Cut)", 7000 / 20, 0, 7000, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_decay_energy_dt_candidate_cut = new TH2D("decay_energy_dt_candidate_cut", "Decay Energy vs Implant-Decay dt (Beta Candidate Cut)", 1500 / 10, 0, 1500, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_strip_dt_candidate_cut = new TH2D("strip_dt_candidate_cut", "Strip XY vs Implant-Decay dt (Beta Candidate Cut)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  ...
  // h1_all_candidate_ionbeta_dt = new TH1D("all_candidate_ionbeta_dt", "Implant-Decay dt (All candidates)", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  ...
  h2_implant_energy_dt_low_multiplicity = new TH2D("implant_energy_dt_low_multiplicity", "Implant Energy vs Implant-Decay dt (Beta Multiplicity < 4)", 7000 / 20, 0, 7000, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_decay_energy_dt_low_multiplicity = new TH2D("decay_energy_dt_low_multiplicity", "Decay Energy vs Implant-Decay dt (Beta Multiplicity < 4)", 1500 / 10, 0, 1500, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_strip_dt_low_multiplicity = new TH2D("strip_dt_low_multiplicity", "Strip XY vs Implant-Decay dt (Beta Multiplicity < 4)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_impstrip_dt_low_multiplicity = new TH2D("impstrip_dt_low_multiplicity", "HEC Strip XY vs Implant-Decay dt (Beta Multiplicity < 4)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  ...
  h1_candidate_ionbeta_dt_low_multiplicity = new TH1D("candidate_ionbeta_dt_low_multiplicity", "Candidate Implant-Decay dt (Beta Multiplicity < 4)", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  ...
  h2_implant_energy_dt_high_multiplicity = new TH2D("implant_energy_dt_high_multiplicity", "Implant Energy vs Implant-Decay dt (Beta Multiplicity > 20)", 7000 / 20, 0, 7000, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_decay_energy_dt_high_multiplicity = new TH2D("decay_energy_dt_high_multiplicity", "Decay Energy vs Implant-Decay dt (Beta Multiplicity > 20)", 1500 / 10, 0, 1500, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_strip_dt_high_multiplicity = new TH2D("strip_dt_high_multiplicity", "Strip XY vs Implant-Decay dt (Beta Multiplicity > 20)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_impstrip_dt_high_multiplicity = new TH2D("impstrip_dt_high_multiplicity", "HEC Strip XY vs Implant-Decay dt (Beta Multiplicity > 20)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  ...
  h1_candidate_ionbeta_dt_high_multiplicity = new TH1D("candidate_ionbeta_dt_high_multiplicity", "Candidate Implant-Decay dt (Beta Multiplicity > 20)", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  ...
  h1_aida_implant_beta_dt_knowngamma_match = new TH1D("aida_implant_beta_dt_knowngamma_match", "Implant-Decay #Deltat (Known Gamma Match);Implant-Decay #deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  ...
  h2_implant_energy_dt_knowngamma_match = new TH2D("implant_energy_dt_knowngamma_match", "Implant Energy vs Implant-Decay dt (Known Gamma Match)", 7000 / 20, 0, 7000, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_decay_energy_dt_knowngamma_match = new TH2D("decay_energy_dt_knowngamma_match", "Decay Energy vs Implant-Decay dt (Known Gamma Match)", 1500 / 10, 0, 1500, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_strip_dt_knowngamma_match = new TH2D("strip_dt_knowngamma_match", "Strip XY vs Implant-Decay dt (Known Gamma Match)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  ...
  h1_aida_implant_beta_dt_unknowngamma_match = new TH1D("aida_implant_beta_dt_unknowngamma_match", "Implant-Decay #Deltat (Unknown Gamma Match);Implant-Decay #deltat (); Counts/", implantDecayBins, -ConfigReader::Instance().GetTimeThreshold(), ConfigReader::Instance().GetTimeThreshold());
  ...
  h2_implant_energy_dt_unknowngamma_match = new TH2D("implant_energy_dt_unknowngamma_match", "Implant Energy vs Implant-Decay dt (Unknown Gamma Match)", 7000 / 20, 0, 7000, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_decay_energy_dt_unknowngamma_match = new TH2D("decay_energy_dt_unknowngamma_match", "Decay Energy vs Implant-Decay dt (Unknown Gamma Match)", 1500 / 10, 0, 1500, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
  h2_strip_dt_unknowngamma_match = new TH2D("strip_dt_unknowngamma_match", "Strip XY vs Implant-Decay dt (Unknown Gamma Match)", 528, 0, 528, implantDecayBins, 0, ConfigReader::Instance().GetTimeThreshold());
